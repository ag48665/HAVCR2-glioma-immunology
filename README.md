# HAVCR2 Is Associated With Immune Infiltration, Macrophage Enrichment, and Poor Prognosis in Glioma
...
Using transcriptomic and clinical data from The Cancer Genome Atlas (TCGA) and independent validation in the Chinese Glioma Genome Atlas (CGGA), we identified **HAVCR2 (TIM-3)** as a robust marker of immune activation, macrophage enrichment, and adverse clinical outcome.
...
* Elevated HAVCR2 expression predicted unfavorable survival in an independent CGGA cohort.
